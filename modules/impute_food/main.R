...
### missing geo codes 530 , 96 , 60, 728
...
timeSeriesData[is.na(type), type := "Food Estimate"]
...
timeSeriesData <-
    merge(
        timeSeriesData,
        averageYearSupply[, c("geographicAreaM49", "measuredItemCPC",
...
if (nrow(data) == 0){
    ...
    dataToSave <- subset(dataToSave, timePointYears %in% c(2019:2020))
