# This script will run with 3 outlooks. We will check net trade (or net trade + prod),
# gdp (or hh expenditure) and the improvements in elasticity.
...
if(nrow(data) == 0){
    ...
    data[, foodHat_Outlook_5 := computeFoodForwardBackward(food = food,
                                                 pop = population,
                                                 elas = updatedElast,
                                                 gdp = hhConsExp,
                                                 netTrade = netSupply,
    ...
    data[, foodHat_Outlook_4 := computeFoodForwardBackward(food = foodNetTrade,
                                                                     pop = population,
                                                                     elas = updatedElast,
                                                                     gdp = GDP,
                                                                     netTrade = netTrade,
    ...
    data[, foodHat_Outlook_3 := computeFoodForwardBackward(food = foodNetTrade,
                                                           pop = population,
                                                           elas = elasticity,
                                                           gdp = hhConsExp,
                                                           netTrade = netTrade,
    ...
    data[, foodHat_Outlook_2 := computeFoodForwardBackward(food = food,
                                                           pop = population,
                                                           elas = elasticity,
                                                           gdp = GDP,
                                                           netTrade = netSupply,
    ...
    data[, foodHat_Outlook_1 := computeFoodForwardBackward(food = foodNetTrade,
                                                           pop = population,
                                                           elas = elasticity,
                                                           gdp = GDP,
                                                           netTrade = netTrade,
    ...
    data_outlooks = copy(data)
    save(data_outlooks, file = "sandbox/presentation/data_outlooks.RData")
